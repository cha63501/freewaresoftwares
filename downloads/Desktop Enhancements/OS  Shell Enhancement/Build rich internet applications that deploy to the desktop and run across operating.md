# Download: Build rich Internet applications that deploy to the desktop and run across operating systems.
...
**Download link:** [Download Build rich Internet applications that deploy to the desktop and run across operating systems.](http://freesoftwares.boysofts.com/Adobe-AIR_program_42448.html)  
...
The AdobeA(r) AIRA runtime lets developers use proven web technologies to build rich Internet applications that deploy to the desktop and run across operating systems. 
