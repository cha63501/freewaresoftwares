# Download: VistaGlazz 2.4

**Short description: **

## Easily modify your Windows installation to use custom styles.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/vistaglazz_md.jpg)   
  
**Download link:** [Download VistaGlazz 2.4](http://freesoftwares.boysofts.com/VistaGlazz_program_29585.html)  
  

**Publisher's Description**  
  

With this simple application you can easily modify your Windows installation
to use custom styles and modify your Aero style to use the Glass effect on
maximized windows.
