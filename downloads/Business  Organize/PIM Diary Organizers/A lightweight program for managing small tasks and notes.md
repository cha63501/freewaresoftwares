# Download: A lightweight program for managing small tasks and notes.
...
**Download link:** [Download A lightweight program for managing small tasks and notes.](http://freesoftwares.boysofts.com/MyTodo_program_38106.html)  
...
A very usable, lightweight and not bloated application for managing all the small tasks and notes that pile up throughout the day. 

It lets you open and save multiple todo lists. Every todo list may contain several todo items that are organized in a tree. Those items again contain information about the todoA's description, status, priority, whether you should be reminded or not and a few others. Besides that, it has a lot of other features in order to make life as comfortable as possible.

Finally, this todo list manager strives to perfectly embedd itself in the everdays life (it is a long way to this though).
