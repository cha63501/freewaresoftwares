# Download: Awesome Password Generator 1.4.0

**Short description: **

## An easy to use application for quick generation of passwords.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/awsmpswdgen_md.jpg)   
  
**Download link:** [Download Awesome Password Generator 1.4.0](http://freesoftwares.boysofts.com/Awesome-Password-Generator_program_73217.html)  
...
**Awesome Password Generator** is an easy to use application for quick generation of common passwords or Wi-Fi (WPA) passphrases. Just launch the generator and a shiny new password will be copied in the clipboard automatically! 
  ...
  * QuickGen: on Windows 7/8 you can generate passwords via taskbar buttonA's menu.
For system administrators/IT-professionals is is also a powerfull tool for
single or bulk password generation, with console version for using from
scripts (examples in batch and PowerShell included :).
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/awsmpswdgen.jpg)  
