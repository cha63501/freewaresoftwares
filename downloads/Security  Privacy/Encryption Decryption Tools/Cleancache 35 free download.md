# Download: CleanCache 3.5

**Short description: **

## A very powerful Internet Explorer, Firefox and Windows 2000/XP cleaner.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/CleanCache3_md.gif)   
  
**Download link:** [Download CleanCache 3.5](http://freesoftwares.boysofts.com/CleanCache_program_16201.html)  
  

**Publisher's Description**  
  

CleanCache is a free (for 1 - 2 systems), very powerful Internet Explorer and
Windows XP cleaner. It will delete all IE tracks (including cleaning/deleting
index.dat files), AutoComplete, WinXP tracks and the deletion of user created
additives.

CleanCache it will delete the following items:
  ...
  * Internet Explorer Form AutoComplete (using either CleanCache 3.0 built in AutoComplete deletion or by using IEA's built in function) 
...
CleanCache runs from the system tray and will clean after Internet Explorer
browser close, Windows startup and Windows Shutdown.
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/CleanCache3.gif)  
