# Download: Provides advanced information on your audio files.
...
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/audioguru10_md.gif)   
  
**Download link:** [Download Provides advanced information on your audio files.](http://freesoftwares.boysofts.com/AudioGuru_program_37559.html)  
...
AudioGuru provides a lower inside into the most popular audio formats. It reveals really advanced information on current audio files like encoding parameters (compression level, sample rate, bitrate, encoder version, etc.) or calculates the uncompressed file size of all supported formats which can become very useful for comparison purposes. 

Additionally AudioGuru reveals all tag fields within a specific tag. Furthermore the content of all tag fields which can be displayed in a hex view. Meta data like text, cover art or binary data can be extracted very easily.
...
**Features:**
  ...
  * Integrates into Windows Explorer's file context menu fA1/4r quick access 

Requires [Microsoft .NET Framework 2.0](http://www.freewarefiles.com/Microsoft-NET-Framework-x-Final_program_16026.html). 

  
  
Screenshot: ![](http://www.freewarefiles.com/screenshot/audioguru10.gif)   
