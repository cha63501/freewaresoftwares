# Download: DivX player with subtitles, skins, playlist and many useful features.
...
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/xvid_md.gif)   
  
**Download link:** [Download DivX player with subtitles, skins, playlist and many useful features.](http://freesoftwares.boysofts.com/XVid--V_program_8033.html)  
...
XVid;-) is a video player. It is designed for watching movies on PC computer, saved in different formats of Windows system, e.g. avi, mpeg, asf, etc..., and especially for playing movies, compressed with DivX codecs (MPEG-4 compression). 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/xvid.gif)   
