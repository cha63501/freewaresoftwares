# Download: Freeware application that converts Flash Video files (FLV, SWF) to AVI or MPG.

**Program name:**

## Pazera Free FLV to AVI Converter Portable 1.8

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/pflv2avicvtr18_md.jpg)   
  
**Download link:** [Download Freeware application that converts Flash Video files (FLV, SWF) to AVI or MPG.](http://freesoftwares.boysofts.com/Pazera-Free-FLV-To-AVI-Converter_program_38244.html)  
...
_Pazera Free FLV to AVI Converter_ is an absolutely free application that converts _Flash Video_ files (**FLV**, **SWF**) to **AVI** or **MPG** (MPEG-1, MPEG-2). 

FLV files are commonly used in the Internet by **Yahoo Video** and other video services. That files are not supported by _Windows Media Player_ and other popular media players. To display FLV video you need to convert that file into more reliable format, such as AVI or MPG. 
...
The _Pazera Free FLV to AVI Converter_ interface is a very simple and user-friendly. To convert flash video files, just _drag & drop_ them into main window and click the _CONVERT_ button. 

The most important features: 

  * Converting FLV and SWF to AVI or MPG.
  * Limited support for other video formats (including **AVI**, **MKV**, **WMV**, MP4, FLV, MTS, OGM, AMV).
  * Decoding the most important audio and video codecs used in Flash Video files: Sorenson H.263, H.264 (AVC), VP6, MP3, AAC, PCM.
  * Supported video encoders: **XviD**, DivX 3, **H.264**, WMV, MPEG4-FFmpeg, S-Mpeg 4 v. 2, Motion JPEG (MJPEG), HuffYUV, MPEG-1, MPEG-2.
  * Supported audio encoders: **MP3 (Lame)**, MP2, **AC3**, AAC, WMA, PCM 16-bit.
  ...
  * The program has a built-in support for multiple languages. Current version supports Czech, English, French, German, Greek, Italian, Japanese, Latvian, Polish, Portuguese (BR), Serbian, Spanish, Turkish.
...
**WhatA's new in version 1.8:**
  ...
  * Added support for additional languages: Greek, Latvian, Portuguese, Turkish.

  
  
Screenshot: ![](http://www.freewarefiles.com/screenshot/pflv2avicvtr18.jpg)   
