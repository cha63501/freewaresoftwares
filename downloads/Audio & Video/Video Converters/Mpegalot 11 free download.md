# Download: MpegALot 1.1

**Short description: **

## Facilitates the encoding of large amounts of videos to the MPEG4+AAC format
(for ipod, PSP, etc).

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/mpegalot_md.gif)   
  
**Download link:** [Download MpegALot 1.1](http://freesoftwares.boysofts.com/MpegALot_program_33545.html)  
  

**Publisher's Description**  
  

MpegALot has one purpose - to facilitate the encoding of large amounts of
videos to the MPEG4+AAC format (for ipod, PSP, etc).

It has several useful features that greatly simplify this task:
  ...
  * Output all encoded files to a single folder or to a directory relative to each sourceA's path 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/mpegalot.gif)  
