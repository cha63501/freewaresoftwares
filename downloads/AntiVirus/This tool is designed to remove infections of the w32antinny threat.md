# Download: This tool is designed to remove infections of the W32.Antinny threat.

**Program name:**

## W32.Antinny Removal Tool 1.1.2

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/sym_w32antinny_md.gif)   
  
**Download link:** [Download This tool is designed to remove infections of the W32.Antinny threat.](http://freesoftwares.boysofts.com/WAntinny-Removal-Tool_program_19271.html)  
...
Follow these steps to download and run the tool:
  ...
  1. Download the FxAntiny.exe file from: http://securityresponse.symantec.com/avcenter/FxAntiny.exe. 
...
Note: If you are sure that you are downloading this tool from the Security Response Web site, you can skip this step. If you are not sure, or are a network administrator and need to authenticate the files before deployment, follow the steps in the "Digital signature" section before proceeding with step 4. 
  ...
  8. Double-click the FxAntiny.exe file to start the removal tool. 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/sym_w32antinny.gif)   
