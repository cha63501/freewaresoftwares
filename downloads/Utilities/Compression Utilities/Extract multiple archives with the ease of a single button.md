# Download: Extract multiple archives with the ease of a single button.

**Program name:**

## ExtractNow Portable 4.8.2.0

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/extractnow4_md.gif)   
  
**Download link:** [Download Extract multiple archives with the ease of a single button.](http://freesoftwares.boysofts.com/ExtractNow_program_8847.html)  
...
ExtractNow allows you to extract more than one archived file at a time, with one click of a button. Makes extracting files quicker and easier. The program supports ZIP, RAR, ACE, JAR, ISO, IMG, IMA, IMZ, BIN, MP3 (MP3>WAV), LHA, LHZ and SIT formats. 
