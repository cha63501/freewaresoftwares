# Download: A performance monitor tool. Displays information such as CPU speed, free RAM, uptime, etc.
...
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/perfmong_md.gif)   
  
**Download link:** [Download A performance monitor tool. Displays information such as CPU speed, free RAM, uptime, etc.](http://freesoftwares.boysofts.com/PerfMonG_program_43316.html)  
...
This project aims to provide a small and simple to use application with functionality similar to Samurize or Linux/Unix based GKrellM. PerfMonG is much simpler, requires no configuration and is ready to use in seconds. 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/perfmong.gif)   
