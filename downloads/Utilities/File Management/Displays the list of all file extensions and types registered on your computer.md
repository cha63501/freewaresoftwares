# Download: Displays the list of all file extensions and types registered on your computer.
...
**Download link:** [Download Displays the list of all file extensions and types registered on your computer.](http://freesoftwares.boysofts.com/FileTypesMan_program_39603.html)  
...
FileTypesMan is an alternative to the A'File TypesA' tab in the A'Folder OptionsA' of Windows. It displays the list of all file extensions and types registered on your computer. For each file type, the following information is displayed: Type Name, Description, MIME Type, Perceived Type, Flags, Browser Flags, and more. 
