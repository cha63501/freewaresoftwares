# Download: A small utility program for notebook computers to turn off their display (LCD) when not in use.
...
**Download link:** [Download A small utility program for notebook computers to turn off their display (LCD) when not in use.](http://freesoftwares.boysofts.com/Turn-Off-LCD_program_43065.html)  
...
There are times when you just want to listen to some music on your notebook/laptop and want the display (LCD) of your notebook to remain off while the lid is still open. While there are a small amount of notebook manufacturerAs who provide this simple option of turning off the notebookAs LCD when not in use, many do not. I own a HP DV2799 Special Edition notebook, while itA's a great notebook in almost every way, it still lacks a basic button to switch off the display (LCD) whenever I want to. This is the case not only for this notebook, but also many new and expensive notebooks. 
