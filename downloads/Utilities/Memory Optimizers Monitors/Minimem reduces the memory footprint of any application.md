# Download: Minimem reduces the memory footprint of any application.
...
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/minimem1_md.jpg)   
  
**Download link:** [Download Minimem reduces the memory footprint of any application.](http://freesoftwares.boysofts.com/Minimem_program_43491.html)  
...
Initially developed for Firefox only, Minimem now can reduce the memory footprint of any application. It runs in the background and can be set up to optimize as many proceses as youA'd like, using a very intuitive graphical interface. Unlike other memory optimization tools, it gives you full control over what applications you want to optimize, when and how often. 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/minimem1.jpg)   
