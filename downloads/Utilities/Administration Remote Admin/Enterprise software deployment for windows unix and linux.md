# Download: Enterprise Software Deployment for Windows, UNIX and Linux.
...
**Download link:** [Download Enterprise Software Deployment for Windows, UNIX and Linux.](http://freesoftwares.boysofts.com/Qunetix-SD-V_program_10702.html)  
...
Qunetix SD Lite is also available for companies who require managed software deployment without the advanced management functionality in 2.0. The Free Version download has a perpetual license to use and/or evaluate the tool. This version contains the full functionality of Qunetix SD 2.0, but is limited to 4 targets. Additional targets can be purchased from $30 US each. 
