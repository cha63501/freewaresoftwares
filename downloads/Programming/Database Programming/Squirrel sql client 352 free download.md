# Download: SQuirrel SQL Client 3.5.2

**Short description: **

## View and manage the structure of a JDBC compliant database.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/squirrelsql_md.jpg)   
  
**Download link:** [Download SQuirrel SQL Client 3.5.2](http://freesoftwares.boysofts.com/SQuirrel-SQL-Client_program_66037.html)  
...
**Features:**
  ...
  * view the databaseA's meta-data, 
  ...
  * and 
  * expand the toolA's capabilities and include DB-specific functionality using 
  * plugins. 
  * Multi-Language 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/squirrelsql.jpg)  
