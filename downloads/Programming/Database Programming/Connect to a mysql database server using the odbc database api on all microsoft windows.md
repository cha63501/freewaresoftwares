# Download: Connect to a MySQL database server using the ODBC database API on all Microsoft Windows and most Unix platforms.

**Program name:**

## MySQL Connector/ODBC (MyODBC) 5.2.6

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/nopic.gif)   
  
**Download link:** [Download Connect to a MySQL database server using the ODBC database API on all Microsoft Windows and most Unix platforms.](http://freesoftwares.boysofts.com/MySQL-ConnectorODBC-MyODBC_program_19970.html)  
...
**[Download MyODBC for Unix systems**](http://dev.mysql.com/downloads/connector/odbc/). 
