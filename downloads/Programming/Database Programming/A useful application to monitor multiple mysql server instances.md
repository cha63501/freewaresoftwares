# Download: A useful application to monitor multiple Mysql server instances.

**Program name:**

## Mysql Monitor Tool 1.2.1

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/mysqlmontool_md.jpg)   
  
**Download link:** [Download A useful application to monitor multiple Mysql server instances.](http://freesoftwares.boysofts.com/Mysql-Monitor-Tool_program_61230.html)  
...
**Features:**
  ...
  * Monitor multiple mysql instances concurrently 
...
**What's New in version 1.2.1:**
  ...
  * Fixed bugs in overlapping charts when servers disconnect 
  * Minor bugfixing 

  
  
Screenshot: ![](http://www.freewarefiles.com/screenshot/mysqlmontool.jpg)   
