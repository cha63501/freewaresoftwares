# Download: Cross-platform (both database and operating system) general purpose database query tool.

**Program name:**

## DBTree (Java Database Tool) 0.8.5

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/kcdbtree_md.gif)   
  
**Download link:** [Download Cross-platform (both database and operating system) general purpose database query tool.](http://freesoftwares.boysofts.com/DBTree-Java-Database-Tool_program_39756.html)  
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/kcdbtree.gif)   
