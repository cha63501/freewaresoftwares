# Download: HashCalc v2.02

**Short description: **

## Compute message digests, checksums and HMACs for files, text and hex
strings.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/hashcalc_md.jpg)   
  
**Download link:** [Download HashCalc v2.02](http://freesoftwares.boysofts.com/HashCalc-V_program_4039.html)  
  

**Publisher's Description**  
  

An easy-to-use calculator that allows to compute message digests, checksums
and HMACs for files, as well as for text and hex strings.
