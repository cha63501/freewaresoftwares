# Download: SunONE UML CASE tool - all UML diagrams, Use Case modeling, ...

**Program name:**

## SDE Community Edition for Sun ONE

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/sde_sunone_md.gif)   
  
**Download link:** [Download SunONE UML CASE tool - all UML diagrams, Use Case modeling, ...](http://freesoftwares.boysofts.com/SDE-Community-Edition-For-Sun-ONE_program_8321.html)  
...
SDE for Sun ONE is a UML CASE tool totally integrated with Sun ONE. It supports full software development lifecycle - analysis, design, implementation, testing and maintenance. It combines the power of UML modeling facilities and Sun ONE. It helps you build quality applications faster, better and cheaper. You can draw UML diagrams in Sun ONE, generate Java code, reverse engineering Java code to class diagrams and generate documentation in PDF/HTML. 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/sde_sunone.gif)   
