# Download: Includes everything you need to run .NET Compact Framework 1.0, 2.0 and 3.5 Beta 1 applications. 
...
**Download link:** [Download Includes everything you need to run .NET Compact Framework 1.0, 2.0 and 3.5 Beta 1 applications. ](http://freesoftwares.boysofts.com/Microsoft-NET-Compact-Framework_program_21274.html)  
...
The MicrosoftA(r) .NET Compact Framework 3.5 Beta1 testing Redistributable contains the common language runtime and class libraries built for the .NET Compact Framework. In addition to supporting version 3.5 beta1, it also supports applications developed for version 2.0 and 1.0. 
