# Download: FlashDevelop 4.6.1

**Short description: **

## Highly customizable lightweight script editor with extended support for
class based languages.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/flashdevelop3_md.gif)   
  
**Download link:** [Download FlashDevelop 4.6.1](http://freesoftwares.boysofts.com/FlashDevelop_program_33914.html)  
...
support for class based languages. Although the program is designed mostly for
ActionScript, other languages can be implemented quite easily too.

FlashDevelop is also very quick and simple to setup and easy-to-use as an
external editor for the Flash IDE or as a complete open source development
environment.
...
**Features:**
  ...
  * Automatically cleans ASO files of modified classes (new) 
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/flashdevelop3.gif)  
