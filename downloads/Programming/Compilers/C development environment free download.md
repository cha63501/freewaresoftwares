# Download: C++ Development Environment

**Short description: **

## Dev-C++ 4: C/C++ IDE, compiler for Win32.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/nopic.gif)   
  
**Download link:** [Download C++ Development Environment](http://freesoftwares.boysofts.com/C-Development-Environment_program_2666.html)  
...
able to create Windows or console-based C/C++ programs using the Mingw
compiler system (version MSCVRT 2.95.2-1 included with this package), or the
Cygwin compiler. It can also handle the Insight Debugger.
