# Download: Circuit Diagram 2.0

**Short description: **

## Open source program to make electronic circuit diagrams and export them as
images.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/circuitdiagram_md.jpg)   
  
**Download link:** [Download Circuit Diagram 2.0](http://freesoftwares.boysofts.com/Circuit-Diagram_program_70334.html)  
  

**Publisher's Description**  
  

Circuit Diagram enables you to make electronic circuit diagrams and allows
them to be exported as images. Ideal for use in coursework, you no longer have
to use image editing programs to paste components together.
