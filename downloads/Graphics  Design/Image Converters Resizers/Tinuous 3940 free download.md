# Download: Tinuous 3.9.4.0

**Short description: **

## An image converter capable of batch-processing multiple files.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/tinuous_md.jpg)   
  
**Download link:** [Download Tinuous 3.9.4.0](http://freesoftwares.boysofts.com/Tinuous_program_83532.html)  
  

**Publisher's Description**  
  

An image converter capable of batch-processing multiple files. JPEG lossless
transformations are implemented. Options are shrink, rotation, correction,
output file name setting, etc.
