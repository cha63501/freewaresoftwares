# Download: Convert images into artwork created from text characters.

**Program name:**

## ASCII Generator dotNet 2.0.0

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/asciigendnet_md.gif)   
  
**Download link:** [Download Convert images into artwork created from text characters.](http://freesoftwares.boysofts.com/ASCII-Generator-DotNet-Beta_program_20615.html)  
...
The ASCII Generator (ASCGEN) is a 32-bit Windows text editor that will allow anyone to easily convert images into artwork created from text characters. 

The ASCGEN provides all the image processing you should need for the conversions, allowing anyone to produce great results with a minimum of effort. Numerous innovations have been made to ensure the best possible output.
...
Screenshot: ![](http://www.freewarefiles.com/screenshot/asciigendnet.gif)   
