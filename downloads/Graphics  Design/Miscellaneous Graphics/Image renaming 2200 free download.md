# Download: Image Renaming 2.2.0.0

**Short description: **

## Add or Append date and time of the picture to the file.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/imageren1109_md.gif)   
  
**Download link:** [Download Image Renaming 2.2.0.0](http://freesoftwares.boysofts.com/Image-Renaming_program_11107.html)  
...
can choose between creation date, file date, last modified and last accessed
date and either append it to the file name, or add it as text overlay directly
into the image(s). If you add it to the image, you can also select the font
type, size and color to be used.
