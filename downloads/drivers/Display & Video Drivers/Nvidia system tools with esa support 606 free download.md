# Download: NVIDIA System Tools with ESA Support 6.06
...
**Download link:** [Download NVIDIA System Tools with ESA Support 6.06](http://freesoftwares.boysofts.com/NVIDIA-System-Tools-with-ESA-Support_program_67363.html)  
  

**Publisher's Description**  
  

Download the latest update for NVIDIA System Tools with ESA Support.

This NVIDIA System Tools installation package adds support for GTX 480 and GTX
470 and it includes the following components:

  1. NVIDIA Performance Group (v6.05.26.05) add-on to the NVIDIA Control Panel 
    * GeForce GPUs A Enables GPU overclocking 
    * nForce MCPs 
  ...
  2. NVIDIA System Monitor (v6.05.25.05) standalone application 
    * GeForce GPUs A Enables GPU temperature monitoring 
    * nForce MCPs 
