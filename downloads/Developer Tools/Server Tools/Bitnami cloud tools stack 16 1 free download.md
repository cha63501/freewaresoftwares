# Download: BitNami Cloud Tools Stack 1.6-1

**Short description: **

## Packages together Amazon Web Services tools with preconfigured Java and
Ruby language runtimes to work out of the box.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/nopic.gif)   
  
**Download link:** [Download BitNami Cloud Tools Stack 1.6-1](http://freesoftwares.boysofts.com/BitNami-Cloud-Tools-Stack_program_73975.html)  
  

**Publisher's Description**  
  

BitNami Cloud Tools Stack packages together Amazon Web Services tools with
preconfigured Java and Ruby language runtimes to work out of the box.
