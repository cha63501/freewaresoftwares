# Download: Server2Go is a Webserver that runs out of box without any installation.
...
**Download link:** [Download Server2Go is a Webserver that runs out of box without any installation.](http://freesoftwares.boysofts.com/ServerGo--_program_21422.html)  
...
Server2Go was build to replace a tool called WampOnCD that lacks some important features and isnA't activly developed.
...
**Note from FreewareFiles:** The download link provided redirects to the developer's default download page. From there, you will be able to download the file directly.
