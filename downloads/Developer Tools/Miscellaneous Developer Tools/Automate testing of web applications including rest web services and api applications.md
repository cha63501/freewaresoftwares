# Download: Automate testing of web applications, including REST web services and API applications.

**Program name:**

## HttpMaster Express 2.2.0

  
**Thumbshot:** ![](http://www.freewarefiles.com/screenshot/httpmaster21_md.jpg)   
  
**Download link:** [Download Automate testing of web applications, including REST web services and API applications.](http://freesoftwares.boysofts.com/HttpMaster_program_86897.html)  
...
When working with HttpMaster, you will use modern user interface with tabs, descriptive icons, A'quick helpA' buttons and integrated help file.  
  
HttpMaster runs on Microsoft Windows XP or later and requires [Microsoft .NET Framework 3.5 SP1](http://www.freewarefiles.com/Microsoft-NET-Framework-3_program_31320.html). 
