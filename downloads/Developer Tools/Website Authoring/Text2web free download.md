...
**Download link:** [Download Text2Web](http://freesoftwares.boysofts.com/TextWeb_program_4880.html)  
  

**Publisher's Description**  
  

**Text2Web** is a tool to convert text documents to html format. It incorporates integrated clipboard support which provides an almost seamless operation for web authors who want to include snippets of text (formatted or unformatted) into their web pages. 
