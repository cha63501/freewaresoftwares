...
## Extensive open source collaborative Web content management system.

  
**Thumbshot: **![](http://www.freewarefiles.com/screenshot/nopic.gif)   
  
**Download link:** [Download CPS 3.3.8](http://freesoftwares.boysofts.com/CPS_program_16662.html)  
...
Web content management system (CMS) implemented on top of Zope and the CMF
(Content Management Framework), that enables organizations to easily, quickly
and efficiently implement collaborative portals (intranet, extranet or
internet) and workflow- oriented business applications. CPS is a software that
enable organizations to implement portalsand workflow.
